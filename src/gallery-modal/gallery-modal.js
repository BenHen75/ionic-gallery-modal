...
var GalleryModal = (function () {
    function GalleryModal(renderer, viewCtrl, params, element, platform, domSanitizer) {
    ...
    GalleryModal.prototype.slideChanged = function () {
        this.currentIndex = this.slider.getActiveIndex();
    };
    GalleryModal.prototype.nextSlide = function () {
        this.slider.slideNext();
    };
    GalleryModal.prototype.previousSlide = function () {
